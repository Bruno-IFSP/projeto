...
if (isset($_POST['nomeprofessor']) && isset($_POST['senhaprofessor'])) {
    ...
    if (strlen($_POST['nomeprofessor']) == 0) {
        ...
        $stmt = $mysqli->prepare("SELECT idprofessor, nomeprofessor FROM Professor WHERE nomeprofessor = ? AND senhaprofessor = ?");
        ...
        if ($stmt->num_rows == 1) {
            ...
            $stmt->close();
            header("Location: topo professor.php");
            exit();
        } else {
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				...
				<a href="cadastra ai professor.php"><button class="ghost" id="signUp">Inscrever-se</button></a>
			</div>
		</div>
	</div>
</div>
